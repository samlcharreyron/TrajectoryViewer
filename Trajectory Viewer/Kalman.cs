...
namespace Trajectory_Viewer
{
    ...
    public class Kalman
    {
        ...
        public Matrix Prediction(double dt)
        {
            ...
            // xpred = x + dx/dt * dt
            result.Data[0] = X.Data[0] + X.Data[2] * dt;

            // zpred  = z + dz/dt * dt
            result.Data[1] = X.Data[1] + X.Data[3] * dt;
        ...
        public Matrix Covariance(double dt)
        {
            ...
            try
            {
                return Matrix.Add(Matrix.MultiplyABAT(F, P), Q);
            }
            catch
            {
        ...
        private void ReloadStateModel(double dt)
        {
            ...
            model.Set(2, 2, 1);
            model.Set(3, 3, 1);
            model.Set(3, 0, dt / 1000);
            model.Set(4, 1, dt / 1000);
